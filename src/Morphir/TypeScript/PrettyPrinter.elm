...
import Morphir.TypeScript.AST exposing (CompilationUnit, ImportDef, ObjectExp, Privacy(..), TypeDef(..), TypeExp(..))
...
mapImports : ImportDef -> String
mapImports importDef =
    concat
        [ "import { "
        , importDef.importRef
        , " } from \""
        , importDef.sourceFile
        , "\""
        ]
